...
const HomeHeroCard = ({
    ...
    return (
        <div className="group border-b-landing-primary relative h-full w-full overflow-visible rounded-t-lg border-b-8 bg-white p-6 pb-10 shadow-md min-h-42 flex items-center justify-center">
