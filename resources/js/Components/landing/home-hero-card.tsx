    ...
    return (
        <div className="group border-b-landing-primary relative h-full w-full overflow-visible rounded-t-lg border-b-8 bg-white p-6 shadow-md">
            <div className="absolute inset-0 z-0">
                ...
                <div
                    className={`absolute inset-0 rounded-t-lg bg-[length:125%_130%] bg-center bg-no-repeat opacity-0 transition-opacity duration-500 ease-in-out group-hover:opacity-100`}
                    style={{
