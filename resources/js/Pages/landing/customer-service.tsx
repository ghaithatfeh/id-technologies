    ...
    return (
        <>
            ...
            >
                ...
                <div
                    className={
                        "flex flex-wrap px-10 md:px-38 absolute -bottom-20 w-full"
                    }
                >
                    <img className="w-1/2 md:w-1/4" src={asset("/images/03-Brand01.png")} />
                    <img className="w-1/2 md:w-1/4" src={asset("/images/04-Brand02.png")} />
                    <img className="w-1/2 md:w-1/4" src={asset("/images/05-Brand03.png")} />
                    <img className="w-1/2 md:w-1/4" src={asset("/images/06-Brand04.png")} />
                </div>
            </div>
