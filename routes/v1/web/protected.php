...
Route::get('/v1/brands/{brandId}/categories/main', [v1\CategoryController::class, 'getMainByBrand'])->name('v1.web.protected.brands.categories.main');
Route::put('/v1/categories/{categoryId}/sort-index', [v1\CategoryController::class, 'updateSortIndex'])->name('v1.web.protected.categories.update.sort_index');
Route::get('/v1/categories/{categoryId}/children', [v1\CategoryController::class, 'getCategoryChildren'])->name('v1.web.protected.categories.children');
...
Route::get('/v1/categories/main', [v1\CategoryController::class, 'getMainCategories'])->name('v1.web.protected.categories.main');
